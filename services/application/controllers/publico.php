    ...
    public function correo_contacto(){
        if($_POST) {
            ...
            if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                //$headers .= "To: Reparadito <noresponder@empresa.com.ar>\n";
                $headers .= "X-Priority: 1\n"; 
                $headers .= "X-MSMail-Priority: High\n"; 
                $headers .= "X-Mailer: PHP/" . phpversion() . " \r\n"; 
                //$headers .= 'Cc: contacto@empresa.com.ar,';
                ...
                mail('empresa@gmail.com', utf8_decode($subject), utf8_decode($sendmessage), utf8_decode($headers), '-fnoresponder@empresa.com.ar');                
