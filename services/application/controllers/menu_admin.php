...
class Menu_Admin extends MY_Controller
{
    ...
    public function listar_menu_admin()
    {
        ...
        $this->load_view('menu_admin/listar_menu_admin', $this->data);
    }

    public function listar_menu_admin_table()
    {
    ...
    public function add_menu_admin_post()
    {
        header("Access-Control-Allow-Origin: *");
        header('Access-Control-Allow-Credentials: true');
        $msg = "";
        if ($_POST) {
            ...
            if (!empty($subItem) AND !empty($tipoInterna) AND !empty($nombre) AND !empty($idNivel) AND !empty($posicion) AND !empty($icono) AND !empty($link) AND !empty($nivel) AND !empty($usuarioAdmin)) {
    ...
    public function modificar_menuAdmin_post()
    {
        ...
        if ($_POST) {
            ...
            if (!empty($subItem) AND !empty($tipoInterna) AND !empty($idMenuAdmin) AND !empty($idNivelGen) AND !empty($nivel) AND !empty($nombre) AND !empty($link) AND !empty($posicion) AND !empty($icono) AND !empty($usuarioAdmin)) {
    ...
    public function eliminar_menu_admin()
    {
        header("Access-Control-Allow-Origin: *");
        header('Access-Control-Allow-Credentials: true');
