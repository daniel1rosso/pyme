...
<div class="page-content">
    ...
    <div class="page-header">
        <div class="page-title">
            <h1  class= "m-5" style="margin: 15% 0%;">Abono <small>Editar</small></h1>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title"><i class="icon-pencil3"></i> Editar abono</h6></div>
        <div class="panel-body">        
            <form id="formEditarAbono" role="form" action="#" method="POST" enctype="multipart/form-data">
                <div id="paso-1" style="padding-bottom:15px;">
                    ...
                    <input type="hidden" id="idEstadoAbono" value="<?= $abono[0]['idEstado'] ?>" class="form-control">
                        ...
                        <div class="col-md-6" style="padding:0px;">
                            <div class="col-md-12">                              
                                <div class="form-group label-floating has-feedback"> 
                                    ...
                                    <select name="selectCliente_formEditarAbono" id="selectCliente_formEditarAbono" class="select-full" required>
                            ...
                            <div class="col-md-12">                              
                                <div class="form-group label-floating has-feedback"> 
                                    ...
                                    <select name="selectCategoriaVenta_formEditarAbono" id="selectCategoriaVenta_formEditarAbono" class="select-full" required>
                            ...
                            <div class="col-md-12">                              
                                <div class="form-group label-floating has-feedback"> 
                                    ...
                                    <select name="selectSubCategoriaVenta_formEditarAbono" id="selectSubCategoriaVenta_formEditarAbono" class="select-full" required>
                            ...
                            <div class="col-md-12" style="padding:0px;">
                                <div class="col-md-12">                              
                                    <div class="form-group label-floating has-feedback"> 
                                        ...
                                        <select name="selectProductos_formEditarAbono" id="selectProductos_formEditarAbono" class="select-full" required>
                            ...
                            <div class="col-md-12" style="padding:0px;">
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <input type="text" id="inputFechaEmision_formEditarAbono" value="<?= $abono[0]['fechaEmision'] ?>" class="form-control date-range-filter" data-date-format="yyyy-mm-dd">
                                ...
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <input type="text" id="inputFechaCobro_formEditarAbono" value="<?= $abono[0]['fechaVtoCobro'] ?>" class="form-control date-range-filter" data-date-format="yyyy-mm-dd">
                                ...
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback"> 
                                        ...
                                        <select name="selectTipoFact_formEditarAbono" id="selectTipoFact_formEditarAbono" class="select-full" required>
                            ...
                            <div class="col-md-12" style="padding:0px;">
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <input type="text" id="inputFechaInicioAbono_formEditarAbono" value="<?= $abono[0]['fechaInicioAbono'] ?>" class="form-control date-range-filter" data-date-format="yyyy-mm-dd">
                                ...
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <input type="text" id="inputFechaFinAbono_formEditarAbono" value="<?= $abono[0]['fechaFinalizacion'] ?>" class="form-control date-range-filter" data-date-format="yyyy-mm-dd">
                                ...
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <select name="selectModalidadAbono_formEditarAbono" id="selectModalidadAbono_formEditarAbono" class="select-full" required>
                            ...
                            <div class="col-md-12" style="padding:0px;">
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <input type="text" id="inputFechaPrimeraVenta_formEditarAbono" value="<?= $abono[0]['fechaPrimerVenta'] ?>" class="form-control date-range-filter" data-date-format="yyyy-mm-dd">
                                ...
                                <?php if ($empresa[0]['idConceptoFactura'] == 2 || $empresa[0]['idConceptoFactura'] == 3): ?>
                                    ...
                                    <div class="col-md-6">                                
                                        <div class="form-group label-floating has-feedback">     
                                            ...
                                            <input type="text" id="inputFechaInicioServicio_abonoupdate" class="form-control date-range-filter" data-date-format="yyyy-mm-dd" autocomplete="off" value="<?= $abono[0]['fechaInicioServicio'] ?>">
                                    ...
                                    <div class="col-md-6">                                
                                        <div class="form-group label-floating has-feedback">     
                                            ...
                                            <input type="text" id="inputFechaFinServicio_abonoupdate" class="form-control date-range-filter" data-date-format="yyyy-mm-dd" autocomplete="off"  value="<?= $abono[0]['fechaFinServicio'] ?>">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="abono">
                                <div class="panel panel-default">
                                    ...
                                    <div class="datatable">
                                        <table class="table table-striped table-bordered" id="listadoAbonoEditar">
                                            <thead>
                                                <tr>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea rows="5" cols="5" id="notaCliente_formEditarAbono" class="form-control" placeholder="Nota para el cliente"><?php if (!empty($abono[0]['notaCliente'])) {
                                    echo $abono[0]['notaCliente'];
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Nota: </label>
                                            <div class="col-sm-10">
                                                <textarea rows="5" cols="5" id="notaInterna_formEditarAbono" class="form-control" placeholder="Nota interna"><?php if (!empty($abono[0]['notaInterna'])) {
                                ...
                                <div class="panel-body">
                                    <div class="row">                            
                                        ...
                                        <div class="col-md-12 form-group label-floating has-feedback">     
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="descEfectuado_formEditarAbono" disabled class="form-control" >
                                            </div>
                                        ...
                                        <div class="col-md-12 form-group label-floating has-feedback">     
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" id="descuentoCliente_formEditarAbono" class="form-control" value="<?= $abono[0]['descuentoCliente'] ?>" onkeyup="totalAbonoEditarDescuentoCliente()">
                                            </div>
                                        ...
                                        <div class="col-md-12 form-group label-floating has-feedback">     
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" id="descuentoTotal_formEditarAbono" disabled class="form-control" >
                                            </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">                            
                                        <div class="col-md-12 form-group label-floating has-feedback">     
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="importeNoGravado_formEditarAbono" disabled class="form-control" >
                                            </div>
                                        ...
                                        <div class="col-md-12 form-group label-floating has-feedback">     
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="totalVenta_formEditarAbono" disabled class="form-control" >
                                            </div>
                ...
                <div style="margin-top:15px;">
                    <span id="btnEditarAbono" class="btn btn-primary btn-raised btn-block">
