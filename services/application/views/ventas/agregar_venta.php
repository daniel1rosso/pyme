...
<div class="page-content">
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title"><i class="icon-pencil3"></i> Agregar venta</h6></div>
        <div class="panel-body">        
            <form id="formNuevaVenta" role="form" action="#" method="POST" enctype="multipart/form-data">
                <div id="paso-1" style="padding-bottom:15px;">
                    ...
                    <input type="hidden" id="venta_presupuesto" value="1" class="form-control">
                            ...
                            <div class="col-md-12" style="padding:0px;">
                                ...
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <div id="errorinputFechaCobroVenta" class="btn-danger erroBoxs" style="display: none">
                                            * Debe completar el campo
                                        </div>   
                                    </div>                                        
                                </div>
                        ...
                        <div class="col-md-6">                              
                            <div class="form-group label-floating has-feedback"> 
                                <div class="form-group label-floating has-feedback">     
                                    ...
                                    <div id="errorSelectRazonSocial" class="btn-danger erroBoxs" style="display: none">
                                        * Debe completar el campo
                                    </div>   
                                </div> 
                            </div>  
                            ...
                            <?php if ($empresa[0]['idConceptoFactura'] == 2 || $empresa[0]['idConceptoFactura'] == 3): ?>
                                <input type="hidden" name="idConceptoFactura" id="idConceptoFactura" value="<?= $empresa[0]['idConceptoFactura'] ?>">
                                <div class="col-md-6" style="padding: initial; padding-right: 10px;">                                
                                    <div class="form-group label-floating has-feedback">     
                                        <label class="control-label" for="inputFechaInicioServicio"><span style="color: red;"> * </span>Fecha Inicio Servicio</label>
                                        <input type="text" id="inputFechaInicioServicio" class="form-control date-range-filter" data-date-format="yyyy-mm-dd" autocomplete="off">

                                        <div id="errorinputFechaInicioServicio" class="btn-danger erroBoxs" style="display: none">
                                            * Debe completar el campo
                                        </div>   
                                    </div>                                        
                                </div>
                                <div class="col-md-6" style="padding: initial; padding-left: 10px;">                                
                                    <div class="form-group label-floating has-feedback">     
                                        <label class="control-label" for="inputFechaFinServicio"><span style="color: red;"> * </span>Fecha Fin Servicio</label>
                                        <input type="text" id="inputFechaFinServicio" class="form-control date-range-filter" data-date-format="yyyy-mm-dd" autocomplete="off">

                                        <div id="errorinputFechaFinServicio" class="btn-danger erroBoxs" style="display: none">
                                            * Debe completar el campo
                                        </div>   
                                    </div>                                        
                                </div>
