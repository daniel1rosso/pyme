...
<div class="page-wrapper">
    ...
    <div class="page-header">
        <div class="page-title">
            <h1 class= "m-5" style="margin: 15% 0%;">Compras</h1>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><h6 class="panel-title"><i class="fas fa-binoculars"></i> Ver compra</h6></div>
        <div class="panel-body">        
            <form id="formModificarCompra" role="form" action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6" style="padding:0px;">
                            <div class="col-md-12">                              
                                <div class="form-group label-floating has-feedback"> 
                                    ...
                                    <select name="selectProveedor_formModificarCompra" id="selectProveedor_formModificarCompra" class="select-full" required disabled>
                                        <?php
                            ...
                            <div class="col-md-12">                              
                                <div class="form-group label-floating has-feedback"> 
                                    ...
                                    <select name="selectCategoriaCompra_formModificarCompra" id="selectCategoriaCompra_formModificarCompra" class="select-full" required disabled>
                                        <?php
                            ...
                            <div class="col-md-12">                              
                                <div class="form-group label-floating has-feedback"> 
                                    <label class="control-label" for="selectSubCategoriaCompra_formModificarCompra"><span style="color: red;"> * </span>Subcategor&iacute;a</label>
                                    <select name="selectSubCategoriaCompra_formModificarCompra" id="selectSubCategoriaCompra_formModificarCompra" class="select-full" required disabled>
                                        <?php
                                        if (isset($subcategoriasComprasDetalle)) :
                                            for ($i = 0; $i < count($subcategoriasComprasDetalle); $i++) :
                                                if ($subcategoriasComprasDetalle[$i]['idSubcategoriaCompra'] == $egreso[0]['idSubCategoriaCompra']):
                                                    echo '<option selected value="' . $subcategoriasComprasDetalle[$i]['idSubcategoriaCompra'] . '">' . $subcategoriasComprasDetalle[$i]['descripcion'] . '</option>';
                                                endif;
                                            endfor;
                                        endif;
                                        ?>     
                                    ...
                                    <div id="errorselectSubCategoriaCompra" class="btn-danger erroBoxs" style="display: none">
                                        * Debe seleccionar una opci&oacute;n
                                    </div>
                                </div>                                            
                            </div>     
                            ...
                            <div class="col-md-12" style="padding:0px;">
                                <div class="col-md-12">                              
                                    <div class="form-group label-floating has-feedback"> 
                                        ...
                                        <select name="selectProductosCompras_formModificarCompra" id="selectProductosCompras_formModificarCompra" class="select-full" required disabled>
                            ...
                            <div class="col-md-12" style="padding:0px;">
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <input type="text" id="inputFechaEmisionCompra_formModificarCompra" name="inputFechaEmisionCompra_formModificarCompra" value="<?= $egreso[0]['fechaEmision'] ?> " class="form-control date-range-filter" data-date-format="yyyy-mm-dd" disabled>
                                ...
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <input type="text" id="inputFechaPagoCompra_formModificarCompra" name="inputFechaPagoCompra_formModificarCompra" value="<?= $egreso[0]['fechaVtoPago'] ?> " class="form-control date-range-filter" data-date-format="yyyy-mm-dd" disabled>
                                ...
                                <div class="col-md-4">                                
                                    <div class="form-group label-floating has-feedback"> 
                                        ...
                                        <select name="selectTipoFactCompra_formModificarCompra" id="selectTipoFactCompra_formModificarCompra" class="select-full" required disabled>
                                            <?php
                            ...
                            <div class="col-md-12">                              
                                <div class="form-group label-floating has-feedback"> 
                                    <div class="form-group label-floating has-feedback">     
                                        ...
                                        <select name="selectRazonSocial" id="selectRazonSocial" class="select-full" required disabled>
                                            <?php
                ...
                llenado_tabla_compra_ver(idGenCompra);</script>
                <div id="paso-2">
                    <div id="boxCabeceraForm">
                        <h3>
                            <small>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active  " id="vercompra">
                                <div class="panel panel-default">
                                    ...
                                    <div class="datatable">
                                        <table class="table table-striped table-bordered" id="listadoCompraVer">
                                            <thead>
                                                <tr>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea rows="5" cols="5" id="notaCliente_formModificarCompra" class="form-control" placeholder="Nota para el proveedor" disabled><?php if (!empty($egreso[0]['notaInterna'])) {
                                    echo $egreso[0]['notaInterna'];
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Nota: </label>
                                            <div class="col-sm-10">
                                                <textarea rows="5" cols="5" id="notaInterna_formModificarCompra" class="form-control" placeholder="Nota interna" disabled><?php if (!empty($egreso[0]['notaInterna'])) {
                                    echo $egreso[0]['notaInterna'];
                                } ?></textarea>
                                            </div>
                                        </div>                                            
                                ...
                                <div class="panel-body">
                                    <div class="row">                            
                                        ...
                                        <div class="col-md-12 form-group label-floating has-feedback">     
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" id="descuentoProveedor_formModificarCompra" class="form-control" onkeyup="totalCompraEditarDescuentoProveedor()" value="<?= $egreso[0]['descuentoProveedor'] ?>" disabled>
                                            </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">                            
                                        ...
                                        <div class="col-md-12 form-group label-floating has-feedback">     
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="totalCompra_formModificarCompra" disabled class="form-control"  value="<?= number_format($egreso[0]['total'], 2, ',', '.') ?>" >
                                            </div>
